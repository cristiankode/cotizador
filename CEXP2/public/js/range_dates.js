...
//		var iFini = document.getElementById('rangoInicioFecha').value;
//		var iFfin = document.getElementById('rangoFinalFecha').value;
//		var iStartDateCol = 6;
//		var iEndDateCol = 7;
//
...
//          
//        // Add event listeners to the two range filtering inputs
//         $('#rangoInicioFecha').keyup( function() {
//             table.draw(); 
//         });
//         
//         $('#rangoFinalFecha').keyup( function() {
//             table.draw(); 
//         });
//     } );